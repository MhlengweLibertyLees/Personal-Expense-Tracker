...
<head>
  <meta charset="UTF-8">
  <title>View All Expenses - Expense Tracker</title>
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="ViewAllExpensesServlet.do">View All Expenses</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="hero">
    <div class="container">
      <h1>All Expenses</h1>
      <p>Manage every expense from the complete list below.</p>
    </div>
  </div>
  
  <!-- Main Content: All Expenses Table -->
  <div class="container my-5">
    <div class="card card-shadow mb-4">
      <div class="card-body">
        <h3 class="card-title mb-4 text-primary">View All Expenses</h3>
